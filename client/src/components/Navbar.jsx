          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            {!user ? (
              <div className="flex items-center gap-4">
                ...
                <Link 
                  to="/register" 
                  className="px-5 py-2.5 bg-emerald-500 hover:bg-emerald-400 text-slate-950 text-sm font-black rounded-xl transition-all shadow-lg shadow-emerald-500/10"
                >
                  Join Platform
                </Link>
              </div>
                  ...
                  {!user ? (
                    <div className="flex flex-col gap-4">
                      <Link 
                        to="/login" 
                        onClick={() => setIsOpen(false)}
                        className="w-full py-4 bg-slate-800 text-center rounded-2xl font-bold"
                      >
                        Login
                      </Link>
                      <Link 
                        to="/register" 
                        onClick={() => setIsOpen(false)}
                        className="w-full py-4 bg-emerald-500 text-slate-950 text-center rounded-2xl font-black"
                      >
                        Join Now
                      </Link>
                    </div>
                    ...
                    <button 
                      onClick={handleLogout}
                      className="w-full flex items-center justify-center gap-3 py-4 bg-rose-500/10 text-rose-400 rounded-2xl font-bold"
                    >
